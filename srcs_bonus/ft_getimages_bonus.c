...
t_icon	ft_readimgs(void *ptr)
{
	...
	show.trap1 = ft_new_sprite(ptr, "img_bonus/T1.xpm");
	show.trap2 = ft_new_sprite(ptr, "img_bonus/T.xpm");
	show.died = ft_new_sprite(ptr, "img_bonus/DIED.xpm");
